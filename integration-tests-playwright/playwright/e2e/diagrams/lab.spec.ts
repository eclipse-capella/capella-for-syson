...
test.describe('LAB diagram', () => {
  let projectId: string;

  test.beforeEach(async ({ page, request }) => {
    const project = await new PlaywrightProject(request).createCapellaProject('functional-LAB');
  ...
  test('creates the representation and a logical component from its palette', async ({ page }) => {
