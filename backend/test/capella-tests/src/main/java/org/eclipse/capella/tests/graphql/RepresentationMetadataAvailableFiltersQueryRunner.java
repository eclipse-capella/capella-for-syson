...
/**
 * Executes the Capella RepresentationMetadata#availableDiagramFilters query.
 *
 * @author Jerome Gout
 */
@Service
public class RepresentationMetadataAvailableFiltersQueryRunner implements IQueryRunner {
    ...
    public RepresentationMetadataAvailableFiltersQueryRunner(IGraphQLRequestor graphQLRequestor) {
