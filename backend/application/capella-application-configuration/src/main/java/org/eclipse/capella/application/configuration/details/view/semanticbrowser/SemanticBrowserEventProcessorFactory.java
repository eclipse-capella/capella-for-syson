...
/**
 * Used to create the semantic browser (related elements) event processors.
 *
 * @author ntinsalhi
 */
@Service
public class SemanticBrowserEventProcessorFactory implements IRepresentationEventProcessorFactory {
    ...
    public SemanticBrowserEventProcessorFactory(RepresentationEventProcessorFactoryConfiguration configuration,
            IRelatedElementsDescriptionProvider semanticBrowserDescriptionProvider,
    ...
    public boolean canHandle(IEditingContext editingContext, String representationId) {
        return representationId.startsWith("semanticBrowser://");
    }
    ...
    public Optional<IRepresentationEventProcessor> createRepresentationEventProcessor(IEditingContext editingContext, String representationId) {
        ...
        if (!objects.isEmpty()) {
            FormDescription formDescription = this.semanticBrowserDescriptionProvider.getFormDescription();
