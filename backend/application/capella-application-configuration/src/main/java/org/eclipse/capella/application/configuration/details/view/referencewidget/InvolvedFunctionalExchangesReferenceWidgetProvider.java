 ...
 */
@Service
public class InvolvedFunctionalExchangesReferenceWidgetProvider implements ICapellaReferenceWidgetProvider {


    public static final String WIDGET_NAME = "InvolvedFunctionalExchangesWidget";

    public static final String FEATURE_NAME = ARCADIA_INVOLVED_FUNCTIONAL_EXCHANGES;
