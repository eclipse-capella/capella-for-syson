...
// Do not exclude anything from the scan here, use CapellaForSysONBeanDefinitionRegistryPostProcessor instead, otherwise
// the excluded bean will be excluded from the standalone application, but not when running Capella for SysON as an extension.
@ComponentScan(basePackages = { "org.eclipse.syson", "org.eclipse.sirius.web", "org.eclipse.sirius.components", "org.eclipse.capella" })
public class CapellaForSysonApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(CapellaForSysonApplication.class, args);
    }
}
