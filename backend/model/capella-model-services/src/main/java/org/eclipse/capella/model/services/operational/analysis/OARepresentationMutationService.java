...
public class OARepresentationMutationService {
    ...
    public PartUsage createEntityComponent(Element parent, boolean isActor) {
        ...
        if (!(parent instanceof PartUsage)) {
            targetContainer = this.oaQueryService.toComponentsPackage(parent);
        }
    ...
    public RequirementUsage createRequirement(Element parent) {
        ...
        Element targetContainer = this.oaQueryService.toRequirementsPackage(parent);
        ...
        requirementUsage.setDeclaredName(name + " " + existingElementsCount);
        return requirementUsage;
    }

    public InterfaceUsage createCommunicationMeanComponentExchange(Feature source, Feature target) {
        var componentExchange = this.transverseRepresentationMutationService.createComponentExchange(source, target);
