 ...
 *******************************************************************************/
package org.eclipse.capella.model.transverse.services.architecture;
...
public final class ArchitectureConstants {
    ...
    public static final String CAPELLA_MODEL_TRANSVERSE_SERVICES = "org.eclipse.capella.model.transverse.services..";

    public static final JavaClasses CLASSES = new ClassFileImporter()
            .withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_JARS)
            .withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_TESTS)
            .importPackages(CAPELLA_MODEL_TRANSVERSE_SERVICES);
