...
/**
 * Root Function node description.
 *
 * @author fbarbin
 */
public class RootFunctionNodeDescriptionProvider extends AbstractNodeDescriptionProvider {

    public static final String NODE_DESCRIPTION_NAME = "RootFunctionNodeDescription";

    public RootFunctionNodeDescriptionProvider(IColorProvider colorProvider) {
        super(colorProvider);
    }
    ...
    public NodeDescription create() {
        ...
        RootFunctionNodeStyleProvider functionNodeStyleProvider = new RootFunctionNodeStyleProvider(this.diagramBuilderHelper, this.colorProvider);
        return this.diagramBuilderHelper.newNodeDescription()
                .collapsible(true)
                .domainType(domainType)
                .insideLabel(new RootFunctionLabelProvider(this.diagramBuilderHelper, this.colorProvider).createInsideLabelDescription())
