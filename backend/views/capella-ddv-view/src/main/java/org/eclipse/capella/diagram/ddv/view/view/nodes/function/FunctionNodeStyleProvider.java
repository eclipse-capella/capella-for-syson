...
public class FunctionNodeStyleProvider {
    ...
    public NodeStyleDescription createFunctionNodeStyle() {
        return this.diagramBuilderHelper.newRectangularNodeStyleDescription()
                .background(this.colorProvider.getColor(DDVViewConstants.CONTEXTUAL_FUNCTION_BACKGROUND_COLOR))
                .borderColor(this.colorProvider.getColor(DDVViewConstants.CONTEXTUAL_FUNCTION_BORDER_COLOR))
                .borderRadius(2)
                .borderSize(2)
                .build();
    }
