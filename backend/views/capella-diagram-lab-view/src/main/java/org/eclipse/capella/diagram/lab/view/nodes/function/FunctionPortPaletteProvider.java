...
/**
 * Provide Palette for Function ports.
 *
 * @author fbarbin
 */
public class FunctionPortPaletteProvider {
    ...
    public FunctionPortPaletteProvider(DiagramBuilders diagramBuilderHelper, ViewBuilders viewBuilderHelper, NodeDeleteFromDiagramToolProvider nodeDeleteFromDiagramToolProvider) {
    ...
    public NodePalette createNodePalette(NodeDescription nodeDescription, IViewDiagramElementFinder cache) {
        ...
        return this.diagramBuilderHelper.newNodePalette()
                ...
                .edgeTools(
                        new FunctionalExchangeToolProvider(this.viewBuilderHelper, this.diagramBuilderHelper).createNewFunctionalExchangeTool(cache))
