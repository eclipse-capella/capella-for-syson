...
/**
 * Provides delete row action used to delete functions in function table.
 *
 * @author ntinsalhi
 */
@Service
public class DeleteFunctionContextMenuEntryExecutor implements IRowContextMenuEntryExecutor {

    private final IEditService editService;

    private final IObjectSearchService objectSearchService;

    public DeleteFunctionContextMenuEntryExecutor(IEditService editService, IObjectSearchService objectSearchService) {
    ...
    public boolean canExecute(IEditingContext editingContext, TableDescription tableDescription, Table table, Line row, String rowMenuContextEntryId) {
        return FunctionTableRowContextMenuProvider.DELETE_ID.equals(rowMenuContextEntryId);
    }
