...
/**
 * Checks the structure of the Operational Analysis Blank diagram.
 *
 * @author gdaniel
 */
public class OABDiagramDescriptionTests extends AbstractEditableDiagramDescriptionTests {
    @Override
    ...
    protected IJavaServiceProvider getJavaServiceProvider() {
        return new OABViewJavaServiceProvider();
    }
}
