...
public class ComponentNodeStyleProvider {
    ...
    public NodeStyleDescription createComponentEntityNodeStyle() {
        return this.diagramBuilderHelper.newRectangularNodeStyleDescription()
                .background(this.colorProvider.getColor(OABViewConstants.COMPONENT_BACKGROUND_COLOR))
                .borderColor(this.colorProvider.getColor(OABViewConstants.COMPONENT_BORDER_COLOR))
                .borderRadius(0)
                .borderSize(2)
                .build();
    }
