 ...
 *******************************************************************************/
package org.eclipse.capella.diagram.oab.view.nodes.requirement.compartment;
...
/**
 * Provides documentation items inside the requirement compartment in OAB.
 *
 * @author tbezierslafosse
 */
public class OABCompartmentItemNodeDescriptionProvider extends AbstractNodeDescriptionProvider {

    private final EClass eClass;

    private final EReference eReference;

    private final DescriptionNameGenerator nameGenerator = new DescriptionNameGenerator("OAB");

    public OABCompartmentItemNodeDescriptionProvider(EClass eClass, EReference eReference, IColorProvider colorProvider) {
        super(colorProvider);
