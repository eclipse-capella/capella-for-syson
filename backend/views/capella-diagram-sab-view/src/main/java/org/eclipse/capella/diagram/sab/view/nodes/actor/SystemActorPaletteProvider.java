 ...
 * @author mbats
 */
public class SystemActorPaletteProvider {
    ...
    public SystemActorPaletteProvider(DiagramBuilders diagramBuilderHelper, NodeDeleteFromDiagramToolProvider nodeDeleteFromDiagramToolProvider) {
