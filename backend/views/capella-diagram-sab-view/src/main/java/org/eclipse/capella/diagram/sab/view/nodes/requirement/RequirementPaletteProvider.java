...
import org.eclipse.capella.diagram.sab.view.edges.describes.DescribesToolProvider;
 ...
 * @author mbats
 */
public class RequirementPaletteProvider {
    ...
    public NodePalette createNodePalette(NodeDescription nodeDescription, IViewDiagramElementFinder cache) {
        var deleteTool = this.diagramBuilderHelper.newDeleteTool()
                ...
                .body(this.viewBuilderHelper.newChangeContext()
                        .expression(ServiceMethod.of0(SAMutationService::deleteRequirement).aqlSelf())
                        .build());
