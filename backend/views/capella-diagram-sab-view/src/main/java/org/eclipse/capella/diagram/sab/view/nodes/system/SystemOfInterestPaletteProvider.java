...
import org.eclipse.capella.diagram.sab.view.nodes.component.SystemComponentToolProvider;
...
/**
 * Provide palette for system node in SAB.
 *
 * @author mbats
 */
public class SystemOfInterestPaletteProvider {

    private final DiagramBuilders diagramBuilderHelper;

    private final ViewBuilders viewBuilderHelper;

    public SystemOfInterestPaletteProvider(DiagramBuilders diagramBuilderHelper) {
