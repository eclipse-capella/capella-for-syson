 ...
 *******************************************************************************/
package org.eclipse.capella.diagram.sab.view.nodes.requirement.compartment;
...
/**
 * Provides documentation items inside the requirement compartment in SAB.
 *
 * @author tbezierslafosse
 */
public class SABCompartmentItemNodeDescriptionProvider extends AbstractNodeDescriptionProvider {

    private final EClass eClass;

    private final EReference eReference;

    private final DescriptionNameGenerator nameGenerator = new DescriptionNameGenerator("SAB");

    public SABCompartmentItemNodeDescriptionProvider(EClass eClass, EReference eReference, IColorProvider colorProvider) {
        super(colorProvider);
