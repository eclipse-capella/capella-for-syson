...
/**
 * Provides the palette for SAB Functional Chain nodes.
 *
 * @author mbats
 */
public class FunctionalChainPaletteProvider {
    ...
    public FunctionalChainPaletteProvider(DiagramBuilders diagramBuilderHelper, ViewBuilders viewBuilderHelper,
    ...
    public NodePalette createNodePalette(NodeDescription nodeDescription, IViewDiagramElementFinder cache) {
        ...
        return this.diagramBuilderHelper.newNodePalette()
                ...
                .toolSections(new DiagramDefaultToolsFactory().createDefaultHideRevealNodeToolSection())
                .build();
    }
}
