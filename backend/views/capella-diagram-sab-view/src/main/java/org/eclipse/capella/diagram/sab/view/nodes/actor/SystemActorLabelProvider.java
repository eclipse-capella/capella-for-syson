 ...
 * @author mbats
 */
public class SystemActorLabelProvider {

    private final DiagramBuilders diagramBuilderHelper;

    private final IColorProvider colorProvider;

    public SystemActorLabelProvider(DiagramBuilders diagramBuilderHelper, IColorProvider colorProvider) {
    ...
    private InsideLabelStyle createHumanActorInsideLabelStyle() {
        return this.diagramBuilderHelper.newInsideLabelStyle()
                .borderSize(0)
                .headerSeparatorDisplayMode(HeaderSeparatorDisplayMode.NEVER)
                .fontSize(12)
