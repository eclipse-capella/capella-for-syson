...
/**
 * Node description for system actors in SAB.
 *
 * @author mbats
 */
public class SystemActorNodeDescriptionProvider extends AbstractNodeDescriptionProvider {

    public static final String NODE_DESCRIPTION_NAME = "SystemActorNodeDescription";

    private static final String COMPONENT_DEFAULT_WIDTH = "180";

    private static final String COMPONENT_DEFAULT_HEIGHT = "70";

    public SystemActorNodeDescriptionProvider(IColorProvider colorProvider) {
        super(colorProvider);
    }
    ...
    public NodeDescription create() {
        ...
        return this.diagramBuilderHelper.newNodeDescription()
                ...
                .insideLabel(new SystemActorLabelProvider(this.diagramBuilderHelper, this.colorProvider).createInsideLabelDescription())
                .name(NODE_DESCRIPTION_NAME)
                .defaultHeightExpression(COMPONENT_DEFAULT_HEIGHT)
                .defaultWidthExpression(COMPONENT_DEFAULT_WIDTH)
                .semanticCandidatesExpression(ServiceMethod.of0(SAQueryService::getSystemActors).aqlSelf())
                .style(new SystemActorNodeStyleProvider(this.diagramBuilderHelper, this.colorProvider).createNodeStyle())
    ...
    public void link(DiagramDescription diagramDescription, IViewDiagramElementFinder cache) {
        cache.getNodeDescription(NODE_DESCRIPTION_NAME).ifPresent(nodeDescription -> {
            ...
            nodeDescription.setPalette(new SystemActorPaletteProvider(this.diagramBuilderHelper, this.nodeDeleteFromDiagramToolProvider).createNodePalette(nodeDescription, cache));
        });
    }
