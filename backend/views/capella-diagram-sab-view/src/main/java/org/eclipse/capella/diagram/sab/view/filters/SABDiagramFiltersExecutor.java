...
/**
 * Filter executor for all filters of SAB diagrams.
 *
 * @author Jerome Gout
 */
@Service
public class SABDiagramFiltersExecutor implements IDiagramFilterExecutor {
    ...
    public SABDiagramFiltersExecutor(IRepresentationDescriptionLabelSearchService representationDescriptionLabelSearchService, IElementNodeFilteringService elementNodeFilteringService) {
    ...
    public boolean canHandle(IEditingContext editingContext, String representationId, String diagramFilterId) {
        return this.representationDescriptionLabelSearchService.findByRepresentationId(editingContext, representationId)
                .filter(label -> Objects.equals(label, SABViewDiagramDescriptionProvider.DESCRIPTION_NAME))
                .isPresent();
    }
