...
/**
 * Provides operational activity creation, label editing and deletion tools.
 *
 * @author tbezierslafosse
 */
public class OperationalActivityPaletteProvider {
    ...
    public OperationalActivityPaletteProvider(DiagramBuilders diagramBuilderHelper, ViewBuilders viewBuilderHelper, NodeDeleteFromDiagramToolProvider nodeDeleteFromDiagramToolProvider) {
