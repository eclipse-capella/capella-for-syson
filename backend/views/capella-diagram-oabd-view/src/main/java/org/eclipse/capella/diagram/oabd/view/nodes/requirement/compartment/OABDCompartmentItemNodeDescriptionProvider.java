...
/**
 * Provides documentation items inside the requirement compartment in OABD.
 *
 * @author tbezierslafosse
 */
public class OABDCompartmentItemNodeDescriptionProvider extends AbstractNodeDescriptionProvider {

    private final EClass eClass;
    private final EReference eReference;
    private final DescriptionNameGenerator nameGenerator = new DescriptionNameGenerator("OABD");

    public OABDCompartmentItemNodeDescriptionProvider(EClass eClass, EReference eReference, IColorProvider colorProvider) {
        super(colorProvider);
