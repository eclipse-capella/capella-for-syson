...
public class RequirementNodeStyleProvider {
    ...
    public NodeStyleDescription createRequirementNodeStyle() {
        return this.diagramBuilderHelper.newRectangularNodeStyleDescription()
                .background(this.colorProvider.getColor(OABDViewConstants.REQUIREMENT_BACKGROUND_COLOR))
                .borderColor(this.colorProvider.getColor(OABDViewConstants.REQUIREMENT_BORDER_COLOR))
                .borderRadius(0)
                .borderSize(2)
