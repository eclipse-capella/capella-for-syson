 ...
 */
@Service
public class RepresentationDescriptionNameService implements IRepresentationDescriptionNameService {

    private final IRepresentationMetadataSearchService representationMetadataSearchService;

    private final IRepresentationDescriptionSearchService representationDescriptionSearchService;

    public RepresentationDescriptionNameService(IRepresentationMetadataSearchService representationMetadataSearchService,
    ...
    @Override
    public Optional<String> getRepresentationDescriptionName(IEditingContext editingContext, String representationId) {
