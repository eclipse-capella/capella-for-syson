 ...
 */
public class CommunicationMeanComponentExchangeEdgeStyleProvider {

    protected final DiagramBuilders diagramBuilderHelper;

    private final IColorProvider colorProvider;

    public CommunicationMeanComponentExchangeEdgeStyleProvider(DiagramBuilders diagramBuilderHelper, IColorProvider colorProvider) {
    ...
    public EdgeStyle createEdgeStyle() {
        return this.diagramBuilderHelper.newEdgeStyle()
                .fontSize(8)
                .borderSize(0)
                .color(this.colorProvider.getColor(OCBViewConstants.COMPONENT_EXCHANGE_BACKGROUND_COLOR))
                .edgeWidth(1)
